...
export function CommandCenter() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* Panel */}
      {open && config && (
        <div className="absolute bottom-12 right-0 w-[380px] bg-[#12122a] border border-gray-800/80 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden z-50 animate-fade-in">
          {/* Header */}
