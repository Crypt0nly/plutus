    ...
    <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex gap-3">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full bg-surface border border-gray-800/60 rounded-xl px-4 py-2.5 text-sm text-gray-100 placeholder-white/30 focus:outline-none focus:border-violet-500/50"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
      ...
      {activeTab === "my-skills" && (
        <div className="space-y-4">
          ...
          {savedSkills.length === 0 ? (
            <div className="text-center py-16 bg-surface border border-gray-800/60 rounded-xl">
            ...
            <div className="space-y-2">
              {savedSkills.map((skill) => {
                const meta = getMeta(skill.category);
                return (
                  <div key={skill.name} className="bg-surface border border-gray-800/60 rounded-xl p-4 flex items-center gap-4">
      ...
      {activeTab === "import" && (
        <div className="space-y-6">
          {/* Upload File */}
          <div className="bg-surface border border-dashed border-violet-500/30 rounded-xl p-8 text-center">
            <div className="text-4xl mb-3">📁</div>
    ...
    "steps": [
      {
        ...
        "params": { "app_name": "{{param1}}" }
              ...
              className="w-full h-48 bg-surface-deep border border-gray-800/60 rounded-xl p-4 text-xs font-mono text-gray-300 placeholder-gray-600 focus:outline-none focus:border-violet-500/50 resize-none"
            />
