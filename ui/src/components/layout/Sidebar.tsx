    ...
    <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
      ...
      <div className="p-5 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">v0.2.8</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 pb-2">
        <div className="rounded-lg bg-plutus-500/10 border border-plutus-500/20 px-3 py-2">
          ...
          <p className="text-xs text-gray-300 mt-0.5 font-medium">WSL shell quoting fix</p>
          <p className="text-[10px] text-gray-500 mt-0.5">v0.2.8 · Feb 23, 2026</p>
        </div>
      </div>
