...
export function SettingsView() {
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="max-w-3xl mx-auto px-4 py-4 sm:p-6 space-y-5 sm:space-y-6">
        {/* Header */}
      ...
      <div className="rounded-2xl p-5" style={{ background: "rgb(var(--surface-alt))", border: "1px solid rgb(var(--gray-700) / 0.4)" }}>
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-200">Workspace Sync</h3>
            <p className="text-xs text-gray-500">Sync files between cloud sandbox and your local machine</p>
          </div>
        </div>
        <WorkspaceSyncView />
      </div>
