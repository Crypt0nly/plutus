...
_CLOUD_CONNECTORS = [
    ...
    },
    {
        ...
        "description": "Send and receive WhatsApp messages using your phone number (requires Node.js).",
        "icon": "MessageCircle",
        "category": "messaging",
        "configured": False,
        "connected": False,
        ...
        "config_schema": [
            {
                ...
                "help": "Your WhatsApp phone number in international format. Used for phone-number pairing — no QR scan needed.",
            },
            {
