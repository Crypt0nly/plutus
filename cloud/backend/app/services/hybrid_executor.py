...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "'update_step' — mark a step in_progress, done, failed, or skipped, "
            "with an optional result note. "
            "'delegate' — pass a step to a background worker (use shell_exec to spawn "
            "a worker script that runs independently and reports back). "
